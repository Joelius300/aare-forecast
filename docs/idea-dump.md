...
- Muesch perf tests mache aber denke 1d partitions und witeri dimension uf run_ts macht Sinn fr prediction
- Teste söttsch ono materialized view fre prediction table wome effektiv wott abfrage (normalerwiis neuste pred run, aber distinct on fr aues miech äuä o sinn (immer di neusti pred pro Punkt))
